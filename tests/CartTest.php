...
namespace Siberfx\Tests\Shoppingcart;

use Mockery;
use PHPUnit\Framework\Assert;
use Siberfx\Shoppingcart\Cart;
use Orchestra\Testbench\TestCase;
use Illuminate\Auth\Events\Logout;
use Illuminate\Support\Collection;
use Siberfx\Shoppingcart\CartItem;
use Illuminate\Support\Facades\Event;
use Illuminate\Session\SessionManager;
use Illuminate\Contracts\Auth\Authenticatable;
use Siberfx\Shoppingcart\ShoppingcartServiceProvider;
use Siberfx\Tests\Shoppingcart\Fixtures\ProductModel;
use Siberfx\Tests\Shoppingcart\Fixtures\BuyableProduct;
...
class CartTest extends TestCase
{
    ...
    /**
     * @test
     * @expectedException \Siberfx\Shoppingcart\Exceptions\InvalidRowIDException
     */
    ...
    /**
     * @test
     * @expectedException \Siberfx\Shoppingcart\Exceptions\UnknownModelException
    ...
    /**
     * @test
     * @expectedException \Siberfx\Shoppingcart\Exceptions\CartAlreadyStoredException
     ...
     *
     * @return \Siberfx\Shoppingcart\Cart
     */
